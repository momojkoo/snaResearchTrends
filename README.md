...
![Preprocessing_flowchart](img/Preprocessing_flowchart.jpg)
## Authors
...
```
1|수소충전소, 신뢰성, 향상, 운전, 데이터, 분석, 시스템, 연구
2|가속수명, 시험, 적용, 볼베어링, 그리스, 주입, 주기, 신뢰성, 평가, 연구
3|kv, 회전기, 절연, 시스템, 열, 시간, 부분, 방전, 절연, 저항, 변화, 고찰
4|배선, 저압차단기, 부품, 간섭, 오동작, 원인, 규명, 공차분석
```
